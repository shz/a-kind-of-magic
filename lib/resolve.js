...
var sort = function(files) {
  ...
  // Crappy naive sort.  The built in sort doesn't work for complex
  // cases.  I'm not even convinced this approach even behaves correctly
  // all the time, and our comparison algorithm is super expensive.
  //
  // So, there are a lot of specific optimizations we can add here...
